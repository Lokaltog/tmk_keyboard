...
#elif defined(KEYMAP_LOKALTOG)
#include "keymap_lokaltog.h"
#else
...
#if defined(KEYMAP_CUB) || defined(KEYMAP_LOKALTOG)

// function keymap_fn_to_action will be defined in keymap_cub.h or keymap_lokaltog.h
